...
import 'package:doctor_app_project/widgets/profile.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Profile(
              hintText: 'Name',
              controller: TextEditingController(text: 'Anwar Abir'),
            ),
            SizedBox(height: 15),
            Profile(
                hintText: 'Email',
            ...
            Profile(
                ...
                controller: TextEditingController(text: '0100000000')),
            SizedBox(height: 15),
            Profile(
                hintText: 'Password',
                controller: TextEditingController(text: 'Rampura,Banasree')),
          ],
        ),
      ),
    );
